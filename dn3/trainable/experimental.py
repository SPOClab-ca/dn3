...
class TVector(Classifier):
    ...
    def __init__(self, targets=None, channels=len(DEEP_1010_CHS_LISTING), samples=None, hidden_size=384,
                 dropout=0.1, ignored_inds=(SCALE_IND,), incoming_channels=None, norm_groups=16, return_tvectors=False):
        self.hidden_size = hidden_size
        self.num_target_people = targets
        self.dropout = dropout
        super(TVector, self).__init__(targets, None, channels, return_features=return_tvectors)
